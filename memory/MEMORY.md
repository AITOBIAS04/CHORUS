...
- Repo-article lacked same-day dedup — re-runs within the same day overwrote the first article with a different angle (Jul 19: volume-decoupling→subtraction; Jul 21: dead-code-audit→MCP-security); original fix PR #37 went DIRTY from volatile files; re-applied as PR #38 (2026-07-22) with targeted staging
